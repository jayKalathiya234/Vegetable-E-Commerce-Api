...
exports.createProductVarient = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: "Product Varient Create SuccessFully...", productVarient: productVarientCreate })
...
exports.getAllProductVarient = async (req, res) => {
    try {
        ...
        if (count === 0) {
            return res.status(404).json({ status: 404, message: "Product Varient Not Found" })
        }
        ...
        return res.status(200).json({ status: 200, totalProductVarient: count, message: "All Product Varient Foudn SuccessFully...", productVarient: paginatedProductVarient })
...
exports.getProductVarientById = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: "Product Varient Found SuccessFully...", productVarient: getProductVarientId })
...
exports.updateProductVarientById = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: 'Product Varient Update SuccessFully...', productVarient: updateProductVarientId })
...
exports.deleteProductVarientById = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: "Product Varient Delete SuccessFully..." })
